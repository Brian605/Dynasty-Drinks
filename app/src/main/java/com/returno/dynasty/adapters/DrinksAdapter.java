...
public class DrinksAdapter extends RecyclerView.Adapter<DrinksAdapter.OfferHolder> implements Filterable {
    private Context context;
    private List<Offer> offerList;
    private List<Offer> filterList;
    private ClickListener listener;

    public DrinksAdapter(Context context, List<Offer> offerList, ClickListener listener) {
    ...
    @NonNull
    @Override
    public DrinksAdapter.OfferHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.drinks_item,parent,false);
        return new OfferHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull DrinksAdapter.OfferHolder holder, int position) {
...
TextView itemTitle, itemCurrentPrice;
