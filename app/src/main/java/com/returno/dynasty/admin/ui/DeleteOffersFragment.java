...
public class DeleteOffersFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        container.removeAllViews();
         ...
         activity.getSupportActionBar().setTitle("Delete Offers");
         ...
         adapter=new DeleteAdapter(getActivity(), offerList, new SelectionListener() {
             @Override
...
syncSelectionStat();
    ...
    private void deleteSelectedItems() {
        ...
        new UploadUtils(selectedIds, Constants.MODE_OFFERS, new DeleteListener() {
            @Override
